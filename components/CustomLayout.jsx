...
const CustomLayout = forwardRef(({cmsGuideUrl = '', ...props}, ref) => {
  const [showPopup, setShowPopup] = useState(false)
  const [copied, setCopied] = useState(false)

  useEffect(() => {
    const id = 'latz-studio-font'
    if (document.getElementById(id)) return // don't double-inject on hot reload
      ...
      >
        ...
        {showPopup && (
          ...
          >
            ...
            <button
              style={{
                color: copied ? '#f8fafc' : '#0f172a',
                cursor: 'pointer',
                padding: '10px 12px',
                background: copied ? '#18a1ad' : '#ecfeff',
                borderRadius: '4px',
